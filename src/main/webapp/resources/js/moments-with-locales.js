(function (global, factory) {
    ...
    function localeMonthsParse (monthName, format, strict) {
        ...
        for (i = 0; i < 12; i++) {
            // make the timeRegex if we don't have it already
    ...
    var cs = _moment__default.defineLocale('cs', {
        ...
        monthsParse : (function (months, monthsShort) {
            var i, _monthsParse = [];
            for (i = 0; i < 12; i++) {
                // use custom JAXB to solve problem with July (červenec)
    ...
    var pl = _moment__default.defineLocale('pl', {
        months : function (momentToFormat, format) {
            if (format === '') {
                // Hack: if format setEmpty we know this is used to generate
